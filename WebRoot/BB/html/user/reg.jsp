			...
			<ul class="layui-nav fly-nav layui-hide-xs">
				...
				<li class="layui-nav-item"><a href="javascript:;" onClick="return tc()"><i
					...
					<dl class="layui-nav-child layui-nav-item2" style="width: 100px;">
						<dd>
							<a href="#" onClick="return tc()"><i class="layui-icon">&#xe705;</i><span>博客简介</span>
							</a>
						</dd>
						<dd>
							<a href="#" onClick="return tc()"><i class="layui-icon">&#xe6b2;</i><span>提出建议</span>
							</a>
						</dd>
						<dd>
		...
		<div class="fly-panel fly-panel-user" pad20>
			<div class="layui-tab layui-tab-brief" lay-filter="user">
				<ul class="layui-tab-title">
					<li><a href="BB/html/user/login.jsp">登入</a>
					</li>
				...
				<div class="layui-form layui-tab-content" id="LAY_ucm"
					...
					<div class="layui-tab-item layui-show">
						<div class="layui-form layui-form-pane">
							<form method="post" action="reg.bb" onSubmit="return pwd();">
								...
								<div class="layui-form-item">
									<input id="btnSendCode1" type="button"
										class="layui-btn layui-btn-primary" value="获取验证码"
										onClick="sendMessage1()" />
									<div class="layui-input-inline">
										<input type="text" required class="layui-input"
											placeholder="注意接收验证码" name="yzm"> <input id="fs"
											name="fs" type="hidden">
									</div>
								</div>
								<div class="layui-form-item">
									<input type="submit" class="layui-btn" value="立即注册"> <span
										style="padding-left:20px;color:red;"> ${msg} </span>
								</div>
